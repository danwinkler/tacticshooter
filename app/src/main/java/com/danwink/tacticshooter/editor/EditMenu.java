...
public class EditMenu extends JMenu implements ActionListener {
	...
	public EditMenu(Editor editor) {
		...
		resizeMenu.setAccelerator(
				KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.KeyEvent.CTRL_DOWN_MASK));
		resizeMenu.setActionCommand("resize");
		resizeMenu.addActionListener(this);
		this.add(resizeMenu);

		JMenuItem undoMenu = new JMenuItem("Undo");
		undoMenu.setAccelerator(
				KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z, java.awt.event.KeyEvent.CTRL_DOWN_MASK));
