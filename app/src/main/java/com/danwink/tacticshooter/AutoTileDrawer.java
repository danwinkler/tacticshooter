...
public class AutoTileDrawer {
	private static DALGraphics gg;
	private static DALTexture imim;
	private static int ht;
	private static int it;
	private static int f;

	public static void draw(DALGraphics g, DALTexture im, int tileSize, int frame, boolean nw, boolean n,
			boolean ne,
			boolean w,
			boolean e, boolean sw, boolean s, boolean se) {
		ht = tileSize / 2;
		it = im.getWidth() / 6;
		gg = g;
		imim = im;
