...
public class DMath {
	...
	public static Point2f lineLineIntersection(Tuple2f a1, Tuple2f a2, Tuple2f b1, Tuple2f b2) {
		...
		// 11/26/11...Why did I think it would be better to make it slower? if it works,
		// it works!
		// 11/28/12 lol @ me
	...
	public static String humanReadableNumber(long i) {
		...
		if (i < 1000000)
			return Math.round((i * 10.0 / 1000)) / 10.0 + " Thousand";
		if (i < 1000000000)
			return Math.round((i * 10.0 / 1000000)) / 10.0 + " Million";
		if (i < 1000000000000l)
			return Math.round((i * 10.0 / 1000000000)) / 10.0 + " Billion";
		return Long.toString(i);
	}
