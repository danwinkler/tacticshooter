...
public class AutoTileDrawer 
{
	...
	{
		gg.drawImage( imim, 0, 0, ht, ht, f+it*x, it*y, f+it*(x+1), it*(y+1), null );
	}
	
	private static void tr( int x, int y )
	{
		gg.drawImage( imim, ht, 0, ht+ht, ht, f+it*x, it*y, f+it*(x+1), it*(y+1), null );
	}
	
	private static void bl( int x, int y )
	{
		gg.drawImage( imim, 0, ht, ht, ht+ht, f+it*x, it*y, f+it*(x+1), it*(y+1), null );
	}
	
	private static void br( int x, int y )
	{
		gg.drawImage( imim, ht, ht, ht+ht, ht+ht, f+it*x, it*y, f+it*(x+1), it*(y+1), null );
	}
}