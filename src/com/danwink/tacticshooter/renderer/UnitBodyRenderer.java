...
public class UnitBodyRenderer
{
	...
	public void drawSpriteBody( Graphics g, Unit u, SpriteSheet baseSheet, SpriteSheet colorSheet, Color color, int size ) 
	{
		g.pushTransform();
	...
	public void draw4DirSpriteBody( Graphics g, Unit u, SpriteSheet baseSheet, SpriteSheet colorSheet, Color color, int size ) 
	{
		g.pushTransform();
	...
	public void draw8DirSpriteBody( Graphics g, Unit u, SpriteSheet baseSheet, SpriteSheet colorSheet, Color color, int size ) 
	{
		g.pushTransform();
