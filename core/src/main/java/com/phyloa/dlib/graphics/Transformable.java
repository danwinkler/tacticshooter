...
/**
 * Basically a layer over jp.objectclub.vecmath.Matrix4f to include pushMatrix()
 * and popMatrix().
 * 
 * Designed to be subclassed.
 * 
 * Allows various transformations to be done to the matrix, and then applied to
 * a Point3f or Vector3f.
 * 
