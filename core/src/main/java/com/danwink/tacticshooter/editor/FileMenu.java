...
public class FileMenu extends JMenu implements ActionListener {
	...
	public FileMenu(Editor editor) {
		...
		newMenu.setAccelerator(
				KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.KeyEvent.CTRL_DOWN_MASK));
		...
		openMenu.setAccelerator(
				KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.KeyEvent.CTRL_DOWN_MASK));
		...
		saveMenu.setAccelerator(
				KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.KeyEvent.CTRL_DOWN_MASK));
